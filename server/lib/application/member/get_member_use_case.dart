...
/// Retrieves a single club member by ID.
class GetMemberUseCase {
  final IMemberRepository _repository;

  const GetMemberUseCase(this._repository);

  /// Returns the [Member] with [id] or throws [MemberNotFoundException].
  Future<Member> execute(String id, {required String entityId}) async {
    final member = await _repository.findById(id, entityId: entityId);
